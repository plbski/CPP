...
int main()
{
    ...
    {
        std::cout << "Exception catch (BadForm1) : " << e.what() << std::endl;
    }
    ...
    {
        std::cout << "Exception catch (BadForm2) : " << e.what() << std::endl;
    }
    ...
    {
        std::cout << "Exception catch (TEST 4) : " << e.what() << std::endl;
    }
    ...
    {
        std::cout << "Exception catch (TEST 5) : " << e.what() << std::endl;
    }
